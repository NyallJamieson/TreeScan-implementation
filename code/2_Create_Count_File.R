...
sample_ED_data <- read.delim("synthetic data for count file/Synthetic_Dataset.txt")
...
icd10_treefile_wide <- read.delim(paste0("files for creating the tree/Tree_File_",year,"_wide_format.txt"))
...
write.table(input_file,paste0("TreeScan input files/Analysis_Count_File.txt"), quote=FALSE, row.names=FALSE, sep="\t", eol="\r\n")
